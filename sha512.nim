...
proc newSha512Hash*(msg: openarray[uint8] = @[]): Sha512Context =
...
proc newSha512Hash*(msg: string): Sha512Context =
  return newSha512Hash(msg.toOpenArrayByte(0, msg.len.pred))


when isMainModule:
  let msg = "some test data"
  var hash = newSha512Hash(msg)
