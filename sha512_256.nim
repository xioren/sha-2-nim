...
# NOTE: a truncated version of SHA-512 with a different set of initial values, producing a 256-bit digest
...
proc padBuffer(ctx: var Sha512_256Context) =
...
proc compress(ctx: var Sha512_256Context) =
...
proc copyShaCtx*(toThisCtx: var Sha512_256Context, fromThisCtx: Sha512_256Context) =
...
proc update*[T](ctx: var Sha512_256Context, msg: openarray[T]) =
...
proc finalize*(ctx: var Sha512_256Context) =
...
proc digest*(ctx: Sha512_256Context): array[32, uint8] =
  ## convert state array[8, uint64] to array[32, uint8]
  ## does not alter hash state
  var tempCtx: Sha512_256Context
...
proc hexDigest*(ctx: Sha512_256Context): string =
  ## convert state array[8, uint64] to hex string of length 64
  ## does not alter hash state
  var tempCtx: Sha512_256Context
  copyShaCtx(tempCtx, ctx)
...
proc newSha512_256Ctx*(msg: openarray[uint8] = @[]): Sha512_256Context =
...
proc newSha512_256Ctx*(msg: string): Sha512_256Context =
  return newSha512_256Ctx(msg.toOpenArrayByte(0, msg.len.pred))


when isMainModule:
  let msg = "some test data"
  var hash = newSha512_256Ctx(msg)
  assert hash.hexDigest() == "814cf74d24e6def6c7aaae47be7c711dc81ca7e4b08a303ca30b3d8aab8e4655"
  hash.update("some more test data")
  assert hash.hexDigest() == "37d5ab2374a09aa8e2a1a1991c8fe5fd6a0447fe35b7cbdda50d76e5179f5072"
